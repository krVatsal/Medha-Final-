...
const HomeworkBloomsTaxonomy: React.FC = () => {
  ...
  const bloomsTaxonomyOptions = ['Remembering', 'Understanding', 'Applying', 'Analyzing', 'Evaluating', 'Creating'];
    ...
    <div>
      <div className="bg-white bg-opacity-60 p-8 rounded-3xl h-[100%] flex flex-col gap-6">
        <div className="flex flex-col mb-4">
          ...
          <div className="text-xs text-gray-500">Select which type of question to include in your homework</div>
        </div>

        <div className="flex flex-col gap-6 p-6 rounded-2xl w-full h-auto">
          {/* Bloom's Taxonomy Section */}
          <SelectableOptions heading="Bloom's Taxonomy" options={bloomsTaxonomyOptions} />

          {/* Difficulty Level Section */}
          <SelectableOptions heading="Difficulty" options={difficultyOptions} />

          {/* Type of Question Section */}
          <SelectableOptions heading="Type of Question" options={questionTypeOptions} />
