...
function CreationArea({ page, setSelectedText,
  ...
  return (
    <div>
      <div className="min-h-[35vh] sm:min-h-[50vh] bg-white bg-opacity-60 p-[15px] rounded-3xl h-[100%] flex flex-col gap-6">
      ...
      {isLoading || buttonLoading ? (
        ...
        <button
          className="text-white bg-[#5D233C] p-2 sm:p-4 mt-6 rounded-full px-6 mb-4"
          onClick={() => {
