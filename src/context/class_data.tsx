export const classDataValues = {
  '6': {
    Science: [
      ...
      { 'Things Around Us': [] },
      { 'The Habitat': [] },
      { 'Plants __ Parts and Functions': [] },
      { 'Form and Movement in Animals and Human Beings': [] },
  ...
  '7': {
    ...
    Science: [
      ...
      { 'Weather; Climatic Changes and Adaptations': [] },
  ...
  '8': {
    ...
    'Social Science': [
      { 'Our Resources': [] },
      { 'Land, Soil, Water and Wildlife': [] },
      { 'Minerals and Power Resources': [] },
      { Agriculture: [] },
      { 'Industries __ An Introduction': [] },
      { 'Human Resources': [] },
      { 'How; When and Where': [] },
      ...
      { 'Urban Changes Under Colonialism': [] },
      { 'Education Under the British Rule': [] },
      { 'Changes in Arts and Architecture': [] },
      { 'Rise of Indian Nationalism': [] },
      { 'India Marches Towards Independence': [] },
      { 'Our Constitution': [] },
      { 'The Parliamentary System of Government': [] },
      { 'The Union Executive': [] },
      { Judiciary: [] },
      { 'Social Justice for Marginalisation': [] },
      { 'Public Facilities': [] },
  ...
  '11': {
    ...
    Physics_1: [
      ...
      { 'MOTION  IN  A  PLANE': [] },
      { 'LAWS OF MOTION': [] },
      { '4.4  NEWTONâ??S FIRST LAW OF MOTION': [] },
      { '4.5  NEWTONâ??S SECOND LAW OF MOTION': [] },
      { '4.6  NEWTONâ??S THIRD LAW OF MOTION': [] },
