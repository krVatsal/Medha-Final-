    ...
    <div className="p-4 lg:p-0">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-4 lg:gap-0">
        <div className="space-y-1">
          <h1 className="text-black text-2xl lg:text-[40px] font-bold">Whiteboards</h1>
        ...
        >
          ...
          <div className="relative w-full lg:w-auto">
            <Image
              ...
              alt=""
            />
            <button className="h-[40px] w-full lg:w-[155px] rounded-full bg-white text-gray-900 pl-8">
              Create Folder
            </button>
          </div>
        </div>
