...
function Chatbot() {
  ...
  const [qna, setQna] = useState([{ question: 'What is Medha?', answer: 'Medha is an AI Chatbot' }]);
      ...
      <div className="p-10 ">
        ...
        <div className="flex justify-between gap-x-[62px]">
          <div className="space-y-1 mb-12 pl-2">
            ...
            <div className="text-[20px] text-gray-500">Chat with AI Chatbot for needs</div>
          </div>
        ...
        <div className="relative pt-4 pl-2">
          <a href="/whiteboard">
            <Image className="absolute left-8 bottom-6 " width={22} height={22} src="/Plus circle.svg" alt="" />

            <button className="h-[65px] w-[240px] bg-white rounded-2xl font-bold">New Notebook</button>
          </a>
        </div>
        ...
        <div className=" text-[20px] text-gray-500 pt-16">
          ...
          <div className="flex gap-6">
            <div className="relative pt-16 pl-4">
              <a href="/whiteboard">
                <Image className="absolute left-8 bottom-6 " width={22} height={22} src="/Book.svg" alt="" />

                <button className="h-[65px] w-[240px] bg-white rounded-2xl font-bold">Notebook 1</button>
              </a>
            </div>
            <div className="relative pt-16 pl-10">
              <a href="/whiteboard">
                <Image className="absolute left-16 bottom-6 " width={22} height={22} src="/Book.svg" alt="" />

                <button className=" h-[65px] w-[240px] bg-white rounded-2xl font-bold">Notebook 2</button>
              </a>
            </div>
          </div>
        </div>
